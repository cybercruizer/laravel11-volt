                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-warning edit-btn"
                                            data-bs-toggle="modal" data-bs-target="#editModal" data-id="{{ $jurusan->id }}"
                                            data-kode="{{ $jurusan->kode }}" data-nama="{{ $jurusan->nama }}"
                                            data-user="{{ $jurusan->user_id }}" data-status="{{ $jurusan->is_active }}">
                                            Edit
                                        </button>
                ...
                <form id="editForm" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kode') is-invalid @enderror" id="edit_kode"
                                name="kode" required>
                            @error('kode')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('user_id') is-invalid @enderror" id="edit_user_id"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('is_active') is-invalid @enderror" id="edit_is_active"
                                name="is_active" required>
                                <option value="1">Aktif</option>
                                <option value="0">Tidak Aktif</option>
                            </select>
